...
--
-- Host: localhost:3306
-- Generation Time: Feb 12, 2026 at 04:09 PM
...
INSERT INTO `appliance` (`appliance_id`, `brand`, `type`, `group`, `category`, `description`, `wattage`, `energy_consumption`, `image`) VALUES
(1, 'Condura', 'No Frost Refrigerator', 'Refrigerator', 'Kitchen', 'Energy-efficient double door refrigerator for daily food storage.', '200', '4.8', NULL),
(2, 'Fujidenzo', 'Chest Freezer', 'Refrigerator', 'Kitchen', 'Large capacity chest freezer for frozen food and meat storage.', '180', '4.3', NULL),
(3, 'Panasonic', 'Inverter Microwave Oven', 'Small Appliances', 'Kitchen', 'Microwave oven with inverter heating for fast and even cooking.', '1200', '1.2', NULL),
(4, 'Condura', 'Rice Cooker', 'Small Appliances\r\n', 'Kitchen', 'Standard rice cooker commonly used in Filipino kitchens.', '700', '0.7', NULL),
(5, 'Fujidenzo', 'Oven Toaster', 'Small Appliances\r\n', 'Kitchen', 'Oven toaster for baking, toasting, and reheating meals.', '1500', '1.5', NULL),
(6, 'Union', 'Desk Electric Fan', 'Fan', 'Kitchen', 'Small desk fan used for kitchen ventilation and cooling.', '40', '0.24', NULL),
(7, 'Panasonic', 'Blender', 'Small Appliances\r\n', 'Kitchen', 'Kitchen blender for shakes, drinks, and food preparation.', '350', '0.35', NULL),
(8, 'Panasonic', '1.5 HP Inverter Split Air Conditioner', 'Air Conditioner', 'Living Room', 'Energy-saving inverter air conditioner for medium-sized rooms.', '1500', '12.0', NULL),
(9, 'Haier', '1.5 HP Inverter Split Air Conditioner', 'Air Conditioner', 'Living Room', 'Quiet and efficient inverter air conditioner with strong cooling.', '1500', '12.0', NULL),
(10, 'Condura', '1.0 HP Window Air Conditioner', 'Air Conditioner', 'Living Room', 'Compact window-type air conditioner ideal for small spaces.', '1100', '8.8', NULL),
(11, 'HKTV', '43 inch LED Smart TV', 'TV', 'Living Room', 'Smart LED television for entertainment and streaming.', '80', '0.4', NULL),
(12, 'Cherry', '50 inch Smart LED TV', 'TV', 'Living Room', 'Large smart TV suitable for family viewing.', '100', '0.5', NULL),
(13, 'Panasonic', '32 inch LED TV', 'TV', 'Living Room', 'Compact LED television with clear display.', '60', '0.3', NULL),
(14, 'Union', 'Stand Electric Fan', 'Fan', 'Living Room', 'Stand fan for air circulation and cooling.', '60', '0.36', NULL),
(15, 'Union', 'Table Fan', 'Fan', 'Bedroom', 'Personal table fan for bedside cooling.', '40', '0.24', NULL),
(16, 'Panasonic', 'Ceiling Fan', 'Fan', 'Bedroom', 'Ceiling fan providing continuous airflow for comfort.', '70', '0.56', NULL),
(17, 'Union', 'Air Cooler', 'Fan', 'Bedroom', 'Evaporative air cooler for energy-efficient cooling.', '200', '1.6', NULL),
(19, 'Haier', 'Air Purifier', 'Small Appliances\r\n', 'Bedroom', 'Air purifier that cleans and filters bedroom air.', '60', '0.36', NULL),
(20, 'Philips', 'LED Desk Lamp', 'Small Appliances\r\n', 'Bedroom', 'Energy-saving LED lamp for reading and studying.', '12', '0.048', NULL),
(21, 'Fujidenzo', 'Mini Refrigerator', 'Refrigerator', 'Bedroom', 'Compact mini fridge for drinks and snacks.', '120', '2.88', NULL),
(30, 'Panasonic', '1.0 HP Window Type', 'Air Conditioner', 'Bedroom', 'trial', '940', '8', '1770770686_698bd0fe8e9f4.jpg');
...
(12, 12, 9, '2026-02-10 15:56:26'),
(16, 13, 10, '2026-02-10 23:39:01'),
(18, 23, 10, '2026-02-11 00:39:12'),
(19, 24, 9, '2026-02-12 14:33:48');
...
(13, 'Lloyd', 'Darantan', 'jnzketaganile@gmail.com', '$2y$12$ac37qJYbQL/mpUSJa1d3Lee/5ARkwhRVf12Eba1I9gA1DmeuuPAWm', '09998819654', 'Philippines', 'Negros Occidental', 'Bacolod City', '12th Street', 'User', '2026-02-05 20:51:32', '2026-02-05 20:51:32'),
...
(21, 'JOHN', 'DARANTAN', 'jnzketaganile@gmail.com', '$2y$12$vyFvZrspQWBFxQff98AdkONsl5hPtEJdzcQYGGgMjRv4EUngAnx82', '09998819654', 'Philippines', 'Negros Occidental', 'Bacolod City', '12th Street', 'User', '2026-02-10 15:58:06', '2026-02-10 15:58:06'),
...
--
ALTER TABLE `appliance`
  MODIFY `appliance_id` int(55) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
